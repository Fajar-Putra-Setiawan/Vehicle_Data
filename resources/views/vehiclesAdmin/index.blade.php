        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-end align-items-center">
                    <a href="{{ route('exportVehicleAdmin') }}" type="button" class="btn btn-warning text-small-on-mobile mx-3">Export</a>
                    <a href="{{ route('vehiclesAdmin.create') }}" type="button" class="btn btn-primary text-small-on-mobile">
            ...
            @include('vehiclesAdmin.tabel', $vehicles)
